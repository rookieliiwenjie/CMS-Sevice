...
public class rabbitmqRouting {
    ...
    private static final String RoutKey = "info";
    ...
    public static void main(String args[]){
        ...
        try {
            ...
            channel.queueBind(QUEUESMS,EXCHANGE,RoutKey);
            for(int i = 0;i<5 ;i++){
                String message = "publish to user";
                //队列绑定交换机
                channel.basicPublish(EXCHANGE,RoutKey,null,message.getBytes());
                /**
                 * Publish a message.
                 *
